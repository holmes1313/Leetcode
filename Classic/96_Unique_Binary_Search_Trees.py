# -*- coding: utf-8 -*-
"""
Created on Wed Dec 25 11:34:33 2019
...
dp[3] = 5, dp[4] =14 , how do we get dp[5] based on these four numbers is the core problem here.
...
there are none; for the right sub tree, we need count how many possible trees 
are there constructed from {2,3,4,5}, apparently it's the same number as {1,2,3,4}. 
So the total number of trees under "1" picked as root is dp[0] * dp[4] = 14. 
